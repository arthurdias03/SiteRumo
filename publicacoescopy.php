...
<head>
    ...
    <meta name="description" content="Publicações acadêmicas do projeto Rumo à Educação Matemática Inclusiva">
    <title>Publicações - Rumo à Educação Matemática Inclusiva</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" role="navigation" aria-label="Menu principal">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link2" href="Home.php">
                            <i class="fas fa-home me-1"></i>Home
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link2" href="Sobre.php">
                            <i class="fas fa-info-circle me-1"></i>Sobre
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link2" href="Equipe.php">
                            <i class="fas fa-users me-1"></i>Equipe
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link2" href="publicacoesteste.php" aria-current="page">
                            <i class="fas fa-book me-1"></i>Publicações
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link2" href="Aplicativos.php">
                            <i class="fas fa-mobile-alt me-1"></i>Aplicativos
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link2" href="Materiais.php">
                            <i class="fas fa-file-alt me-1"></i>Materiais
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link2" href="Contato.php">
    ...
    <header class="header-section">
        <div class="container">
            <div class="logo-container">
                <img src="Img/icones/Logo_rumoPNG.png" alt="Logo do projeto Rumo à Educação Matemática Inclusiva" 
                     width="100" height="100">
                <div>
                    <h1 class="page-title">Publicações Acadêmicas</h1>
                    <p class="subtitle">Rumo à Educação Matemática Inclusiva</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-content">
                <a href="Home.php" aria-label="Voltar ao início">
                    <img src="Img/icones/Logo_rumoPNG.png" alt="Logo Rumo" width="70" height="50">
                </a>
                
                <div class="footer-logos">
                    <img src="Img/icones/logo_fapesp.png" alt="Logo FAPESP" width="90" height="50">
                    <img src="Img/icones/CNPq_v2017_rgb.png" alt="Logo CNPq" width="90" height="40">
                    <img src="Img/icones/banner_capes-1024x871.png" alt="Logo CAPES" width="70" height="50">
                </div>
            </div>
        </div>
    </footer>

...
<head>
    ...
    <title>Upload - Área Administrativa</title>
                ...
                <div class="security-info">
                    ...
                    <div class="security-features">
                        <span class="security-badge">
                            <i class="fas fa-file-shield me-1"></i>Validação de Arquivo
                        </span>
                        <span class="security-badge">
                            <i class="fas fa-virus-slash me-1"></i>Verificação de Tipo
                        </span>
                        <span class="security-badge">
                            <i class="fas fa-weight-hanging me-1"></i>Limite de Tamanho
                        </span>
                        <span class="security-badge">

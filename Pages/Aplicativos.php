...
<!--logo site-->
  ...
  <div class="row align-items-center">
    <div class="col-auto">
      <div class="logo">
        <img src="RUMOSITEBANCO/Pages/Img/icones/Logo_rumoPNG.png" alt="Logo" width="100" height="100" class="d-inline-block align-text-top">
...
<div class="container text-center respons-foot">
  <div class="row g-2">
    <div class="col-3">
      <div class="p-3">
        <div class="card" style="width: 100%;">
          <img src="/Pages/Img/imgs_old/aplicativo_1.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            ...
            <a onclick="downloadExe()" href="/Pages/Aplicativos/Calcolorida_v6.exe" class="btn btn-primary">Atividade</a>
          </div>
        </div>
      </div>
    </div>
    <div class="col-3">
      <div class="p-3">
        <div class="card" style="width: 100%;">
          <img src="/Pages/Img/imgs_old/aplicativo_2.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <h3>Mathsticks </h3>
            ...
            <a onclick="downloadExe()" href="/Pages/Aplicativos/mathsticks (portugues).exe" class="btn btn-primary">Atividade</a>
          </div>
        </div>
      </div>
    </div>
    <div class="col-3">
      <div class="p-3">
        <div class="card" style="width: 100%;">
          <img src="/Pages/Img/imgs_old/aplicativo_4.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <h3>Ritmática</h3>
            ...
            <a onclick="downloadExe()" href="/Pages/Aplicativos/ritmatica_beta_site.exe" class="btn btn-primary">Atividade</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-3">
      <div class="p-3">
        <div class="card" style="width: 100%;">
          <img src="/Pages/Img/imgs_old/aplicativo_5.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <h3>Transtaruga</h3>
            ...
            <a onclick="downloadExe()" href="/Pages/Aplicativos/trans_taruga_v1_At1-8.exe" class="btn btn-primary">Atividade</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <footer class="navbar  fixed-bottom bg-footer">
    ...
    <script src="/Pages/js/baixar_app_e_descricao.js"></script>
  </body>
</html>
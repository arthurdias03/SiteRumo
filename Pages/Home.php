...
<html lang="pt-br">
  ...
  <body class="test">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-body-blue" aria-label="Tenth navbar example">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class=" nav-link2" aria-current="page" href="/Pages/Home.php" >Home</a>
            </li>
            <li class="nav-item">
              <a class=" nav-link2 " href="/Pages/Sobre.php">Sobre</a>
            </li>
            <li class="nav-item">
              <a class=" nav-link2" href="/Pages/Equipe.php">Equipe </a>
            </li>
            <li class="nav-item">
              <a class=" nav-link2" aria-disabled="true" href="Pages/Publicações.php">Publicações</a>
            </li>
            <li class="nav-item">
              <a class=" nav-link2" aria-disabled="true" href="/Pages/Aplicativos.php">Aplicativos</a>
            </li>
            <li class="nav-item">
              <a class=" nav-link2" aria-disabled="true" href="/Pages/Materiais.php">Materiais</a>
            </li>
            <li class="nav-item">
              <a class=" nav-link2" aria-disabled="true" href="/Pages/Contato.php">Contato</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <main class="container-fluid text-center">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <video autoplay controls src="/Pages/video/home.mp4" height="400" width="100%"></video>
        </div>
    ...
    <footer class="navbar fixed-bottom bg-footer">
      <div class="container-fluid">
        <a class="navbar-brand" href="/Pages/Home.php"><img src="/Pages/Img/icones/Logo_rumoPNG.png" alt="Logo" width="70" height="50" class="d-inline-block align-text-top" style="margin-left: 15px;"></a>
        <div class="d-flex">
